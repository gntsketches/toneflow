<template>
  ...
  <div id="qwerty" :class="{ activeRegion: activeRegion === 'qwerty-player' }" >
    ...
    <ul id="keyboard">
      ...
      <li :class="{ active: allDown.indexOf('x') >-1 || allDown.indexOf('X') >-1 }" @mousedown="startPitch('x')" @mouseup="stopPitch('x')" @mouseleave="stopPitch('x')" ref="qwerty-x" class="letter">{{ qwertyVals["x"] }}</li>
      <li :class="{ active: allDown.indexOf('c') >-1 || allDown.indexOf('C') >-1 }" @mousedown="startPitch('c')" @mouseup="stopPitch('c')" @mouseleave="stopPitch('c')" class="letter">{{ qwertyVals["c"] }}</li>
      <li :class="{ active: allDown.indexOf('v') >-1 || allDown.indexOf('V') >-1 }" @mousedown="startPitch('v')" @mouseup="stopPitch('v')" @mouseleave="stopPitch('v')" class="letter">{{ qwertyVals["v"] }}</li>
      <li :class="{ active: allDown.indexOf('b') >-1 || allDown.indexOf('B') >-1 }" @mousedown="startPitch('b')" @mouseup="stopPitch('b')" @mouseleave="stopPitch('b')" class="letter">{{ qwertyVals["b"] }}</li>
      <li :class="{ active: allDown.indexOf('n') >-1 || allDown.indexOf('N') >-1 }" @mousedown="startPitch('n')" @mouseup="stopPitch('n')" @mouseleave="stopPitch('n')" class="letter">{{ qwertyVals["n"] }}</li>
      <li :class="{ active: allDown.indexOf('m') >-1 || allDown.indexOf('M') >-1 }" @mousedown="startPitch('m')" @mouseup="stopPitch('m')" @mouseleave="stopPitch('m')" class="letter">{{ qwertyVals["m"] }}</li>
      <li :class="{ active: allDown.indexOf(',') >-1 || allDown.indexOf('<') >-1 }" @mousedown="startPitch(',')" @mouseup="stopPitch(',')" @mouseleave="stopPitch(',')" class="symbol">{{ qwertyVals[","] }}</li>
      <li :class="{ active: allDown.indexOf('.') >-1 || allDown.indexOf('>') >-1 }" @mousedown="startPitch('.')" @mouseup="stopPitch('.')" @mouseleave="stopPitch('.')" class="symbol">{{ qwertyVals["."] }}</li>
      <li :class="{ active: allDown.indexOf('/') >-1 || allDown.indexOf('?') >-1 }" @mousedown="startPitch('/')" @mouseup="stopPitch('/')" @mouseleave="stopPitch('/')" class="symbol">{{ qwertyVals["/"] }}</li>
      <li :class="{ active: allDown.indexOf('Shift') >-1 }" class="right-shift lastitem"></li>
    </ul>
    {{ down }}
  </div>
